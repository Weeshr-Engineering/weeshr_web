    ...
    <InterfaceLayout>
      ...
      <WidthLayout narrow={true}>
        <div className="w-full m-auto flex items-center justify-center ">
          <main className="flex flex-col items-center mb-5 w-full max-w-md  justify-center md:w-[28rem] lg:w-full lg:flex lg:max-w-[910px] lg:bg-transparent bg-bg-[url('https://res.cloudinary.com/dufimctfc/image/upload/v1724611896/1720185385686_dsfn3s.png');] lg:flex-nowrap md:p-6 pt-0 md:pt-6 lg:p-0 rounded-2xl lg:flex-row ">
