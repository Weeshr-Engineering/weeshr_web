...
const HomePage: React.FC = () => {
  ...
  return (
    <WidthLayout>
      <div className="container px-[0.5px] mx-auto text-black">
        ...
        <div className="flex flex-col md:flex-row w-full p-6 px-4 mt-16 rounded-lg bg-white/60 backdrop-blur-3xl">
          <div className="w-full md:w-1/2 px-4">
            ...
            <div className="p-5 mt-4 bg-white rounded-lg">
              ...
              <div className="space-y-3 text-muted-foreground">
                <p>
                  Account deletion is permanent. Your data, wishes, weeshr
                  connect and moments will be erased. Shared content may remain
          ...
          <div className="w-full md:w-1/2 mt-8 md:mt-0 ml-4 ">
            ...
            <Accordion
              type="single"
              collapsible
              className="w-[88%] md:w-full mt-8 md:mt-3  "
            >
