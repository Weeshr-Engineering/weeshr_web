    ...
    <div className="text-black   pt-[100px] pb-2 md:pb-6 text-black   pt-[100px] pb-6 bg-white  md:bg-[url('https://res.cloudinary.com/dufimctfc/image/upload/v1724865851/BGLong_hkaxwc.svg');] bg-no-repeat bg-cover min-h-screen bg-fixed	">
      ...
      <section className="w-full px-6 mx-auto sm:w-8/12">
        ...
        <ul className="mt-2 list-disc list-inside text-muted-foreground">
          ...
          <li>
            <strong>Affiliate:</strong> Any entity that controls, is controlled
            by, or is under common control with the Company, where "control"
            means ownership of internally specified shares, equity interest, or
          ...
          <li>
            ...
            including but not limited to text, images, videos, audio, graphics,
            and software.
          </li>
          <li>
        ...
        <p className="mt-2 text-muted-foreground">
          ...
          guardian who agrees to be bound by these Terms. If You are creating an
        ...
        <ul className="mt-2 list-disc list-inside text-muted-foreground">
          ...
          <li>
            Post any content that is defamatory, abusive, harassing, obscene, or
