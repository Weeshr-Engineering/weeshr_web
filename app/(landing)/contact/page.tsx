				...
				<div className="relative">
					<div className="text-black  ">
						<div className="px-4 pt-16 mx-auto text-center max-w-7xl sm:px-6 lg:px-8">
							<h2 className="text-3xl lg:text-4xl font-medium dark:text-gray-100">
								Contact
								<span
									className={`relative whitespace-nowrap px-2 bg-gradient-custom bg-clip-text text-transparent text-3xl lg:text-4xl `}
						...
						<div className="mt-10 pt-8 mb-10 mx-auto sm:px-16 bg-white/70 rounded-lg backdrop-blur-sm lg:flex">
							<div className="text-center lg:text-start px-5 lg:w-6/12">
								<h2 className="text-lg text-dark font-bold  ">
									Drop us a message
								</h2>
								<p className="mt-4 mb-4 text-dark w-full text-base">
