    ...
    <WidthLayout>
      <div className="text-black   ">
        ...
        <section className="w-full px-6 mx-auto sm:w-8/12">
          ...
          <p className="mb-4 text-muted-foreground text-md">
          ...
          <ul className="mb-4 ml-8 list-disc text-muted-foreground text-md">
            <li>
            ...
            <li>
              <strong>Application:</strong> refers to Weeshr, the software
          ...
          <ul className="mb-4 ml-8 list-disc text-muted-foreground text-md">
            ...
            <li>LinkedIn</li>
            <li>
              All other social media platforms or any platform as implemented
              and allowed
            </li>
          </ul>
          <p className="mb-4 text-muted-foreground text-md">
            ...
            activities or Your contact list associated with that account and
          ...
          <p className="mb-4 text-muted-foreground text-md">
            Other legal requirements: The Company may disclose Your Personal
